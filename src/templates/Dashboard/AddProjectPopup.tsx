...
const AddProjectPopup = ({ closePopup }: { closePopup: () => void }) => {
  const {
    register,
    formState: { errors },
    handleSubmit,
        ...
        >
          <Box display="flex" alignItems="center" gap="8px" justifyContent="space-between">
            <Typography fontWeight="semibold" fontSize="xl">
              {dashboardTemplateConstant.projectTitle}
            </Typography>
            <Close size="xLarge" onClick={closePopup} />
          </Box>
          <Typography fontSize="xs" color="gray">
            {dashboardTemplateConstant.projectDescription}
          </Typography>
        </Box>
          ...
          >
            ...
            >
              <Typography fontSize="sm" fontWeight="semibold">
                {dashboardTemplateConstant.projectName}
              </Typography>
              <Input
                ...
                errorMessage={errors['project-name']?.message as string | undefined}
              />
            </Box>
            <Box
              display="flex"
            ...
            >
              <Button color="dark" size="small" roundness="rounded" type="submit">
                {dashboardTemplateConstant.projectButton}
              </Button>
            </Box>
          </Box>
        </Form>
